...
namespace WebApiAutores.Controllers
{
    ...
    public class LibrosController : ControllerBase
    {
        ...
        {
            var libro = await context.Libros.Include(x => x.Comentarios)
        ...
        public async Task<ActionResult> Post(LibroCreacionDTO libroCreacionDTO)
        {
            ...
            var autores = await context.Autores.Where(a => libroCreacionDTO.AutoresIds.Contains(a.Id)).Select(x => x.Id).ToListAsync();
